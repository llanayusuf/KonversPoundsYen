...
public class konvertPounds extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_konvert_pounds);
    ...
    public void onClick(View view) {
        ...
        double hasil = Double.parseDouble(satuan.getText().toString())*0.000058;

        data.setData(Uri.parse(String.valueOf(hasil)));

        buttonhasil.setText(String.format("P. %s", String.valueOf(hasil)));
